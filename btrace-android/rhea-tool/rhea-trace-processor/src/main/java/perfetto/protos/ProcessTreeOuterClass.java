...
public final class ProcessTreeOuterClass {
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
      ...
      /* patch= */ 3,
      /* suffix= */ "",
      ProcessTreeOuterClass.class.getName());
  }
  ...
  private static final long serialVersionUID = 0L;
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 3,
        /* suffix= */ "",
        ProcessTree.class.getName());
    }
    // Use ProcessTree.newBuilder() to construct.
    private ProcessTree(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    private ProcessTree() {
    ...
    private static final long serialVersionUID = 0L;
      ...
      public static final class Builder extends
        ...
        private void ensureNstidIsMutable() {
          if (!nstid_.isModifiable()) {
            nstid_ = makeMutableCopy(nstid_);
          }
          bitField0_ |= 0x00000008;
        }
        /**
    ...
    public interface ProcessOrBuilder extends
       ...
       * </pre>
       *
       * <code>optional uint64 process_start_from_boot = 7;</code>
       * @return Whether the processStartFromBoot field is set.
       */
       ...
       *
       * <code>optional uint64 process_start_from_boot = 7;</code>
       * @return The processStartFromBoot.
       */
    ...
    private static final long serialVersionUID = 0L;
      ...
      private long processStartFromBoot_ = 0L;
      /**
       * <pre>
       * Timestamp of when the process was created, in nanoseconds
       * from boot. Parsed from starttime in /proc/pid/stat.
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output)
        ...
        for (int i = 0; i < cmdline_.size(); i++) {
          com.google.protobuf.GeneratedMessage.writeString(output, 3, cmdline_.getRaw(i));
        }
        if (((bitField0_ & 0x00000004) != 0)) {
        ...
        if (((bitField0_ & 0x00000008) != 0)) {
          output.writeUInt64(7, processStartFromBoot_);
        }
        getUnknownFields().writeTo(output);
      }
      ...
      public int getSerializedSize() {
        ...
        if (((bitField0_ & 0x00000008) != 0)) {
          size += com.google.protobuf.CodedOutputStream
            .computeUInt64Size(7, processStartFromBoot_);
        }
        size += getUnknownFields().getSerializedSize();
        memoizedSize = size;
        return size;
      ...
      public boolean equals(final java.lang.Object obj) {
        ...
        if (hasProcessStartFromBoot() != other.hasProcessStartFromBoot()) return false;
        if (hasProcessStartFromBoot()) {
          if (getProcessStartFromBoot()
              != other.getProcessStartFromBoot()) return false;
        }
        if (!getUnknownFields().equals(other.getUnknownFields())) return false;
        return true;
      }
      ...
      public int hashCode() {
        ...
        if (hasProcessStartFromBoot()) {
          hash = (37 * hash) + PROCESS_START_FROM_BOOT_FIELD_NUMBER;
          hash = (53 * hash) + com.google.protobuf.Internal.hashLong(
              getProcessStartFromBoot());
        }
        hash = (29 * hash) + getUnknownFields().hashCode();
        memoizedHashCode = hash;
        return hash;
      ...
      public static final class Builder extends
        ...
        private void buildPartial0(perfetto.protos.ProcessTreeOuterClass.ProcessTree.Process result) {
          ...
          if (((from_bitField0_ & 0x00000020) != 0)) {
            result.processStartFromBoot_ = processStartFromBoot_;
        ...
        public Builder mergeFrom(perfetto.protos.ProcessTreeOuterClass.ProcessTree.Process other) {
          ...
          if (other.hasProcessStartFromBoot()) {
            setProcessStartFromBoot(other.getProcessStartFromBoot());
          }
          this.mergeUnknownFields(other.getUnknownFields());
          onChanged();
          return this;
          ...
          try {
            ...
            while (!done) {
              ...
              switch (tag) {
                ...
                case 56: {
                  processStartFromBoot_ = input.readUInt64();
        ...
        private void ensureNspidIsMutable() {
          if (!nspid_.isModifiable()) {
            nspid_ = makeMutableCopy(nspid_);
          }
          bitField0_ |= 0x00000010;
        }
        /**
         ...
         *
         * <code>optional uint64 process_start_from_boot = 7;</code>
         * @param value The processStartFromBoot to set.
         * @return This builder for chaining.
         */
        public Builder setProcessStartFromBoot(long value) {

          processStartFromBoot_ = value;
          bitField0_ |= 0x00000020;
          onChanged();
          return this;
        }
    ...
    private static final com.google.protobuf.Parser<ProcessTree>
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "proto\022\017perfetto.protos\"\332\002\n\013ProcessTree\0227" +
      ...
      "tid\030\004 \003(\005\032x\n\007Process\022\013\n\003pid\030\001 \001(\005\022\014\n\004ppi" +
      "d\030\002 \001(\005\022\017\n\007cmdline\030\003 \003(\t\022\013\n\003uid\030\005 \001(\005\022\r\n" +
      "\005nspid\030\006 \003(\005\022\037\n\027process_start_from_boot\030" +
      "\007 \001(\004J\004\010\004\020\005"
    };
    ...
    internal_static_perfetto_protos_ProcessTree_Process_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessage.FieldAccessorTable(
        internal_static_perfetto_protos_ProcessTree_Process_descriptor,
        new java.lang.String[] { "Pid", "Ppid", "Cmdline", "Uid", "Nspid", "ProcessStartFromBoot", });
